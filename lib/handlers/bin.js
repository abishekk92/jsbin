...
module.exports = Observable.extend({
  ...
  getFromPost: function (req, res, next) {
    ...
    if (req.body.js && !data.javascript) {
      data.javascript = req.body.js;
    }
  ...
  createdTime: function(req,res,next){
      var revision = parseInt(req.params.rev,10) || 1,
      query= { id: req.params.bin, revision: revision},
      helpers=this.helpers;
    ...
    this.models.bin.createdTime(query,complete);
  },
  checkCreated: function(createdTime){
    time_limit=10000;
